...
|-----------|-------------------|
| Orchestrator | `happys edison -- read ORCHESTRATOR --type constitutions` |
| Agent (Implementer) | `happys edison -- read AGENTS --type constitutions` |
| Validator | `happys edison -- read VALIDATORS --type constitutions` |
