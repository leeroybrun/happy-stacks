---
description: "Find likely duplicate/similar tasks (deterministic similarity index)"
edison-generated: true
edison-id: "task-similar"
edison-platform: "claude"
argument-hint: "--query --task --top --threshold --only-todo --states --json"
---
